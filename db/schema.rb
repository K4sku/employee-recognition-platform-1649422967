...
ActiveRecord::Schema.define(version: 2022_04_23_175037) do
  ...
  create_table "employees", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.integer "number_of_available_kudos", null: false
  ...
  add_foreign_key "kudos", "employees", column: "reciever_id"
end
